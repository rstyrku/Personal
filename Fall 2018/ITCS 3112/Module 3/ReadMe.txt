...
The input data file format is text, and  will contain the width, height and  width*height values  in sequence. See for example  this input image data:   Colorado_480x480.datPreview the document   
